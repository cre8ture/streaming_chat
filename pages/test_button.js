  ...
  return (
    <div className="button-group">
      ...
      >
        ...
        {clickedButtons[0] && <span dangerouslySetInnerHTML={{ __html: checkmark }} />}
      </button>
      ...
      >
        ...
        {clickedButtons[1] && <span dangerouslySetInnerHTML={{ __html: checkmark }} />}
      </button>
      ...
      >
        ...
        {clickedButtons[2] && <span dangerouslySetInnerHTML={{ __html: checkmark }} />}
      </button>
    </div>
  );
};
